...
#Se crea una matriz  2X2 inversa vacia
...
inversematrix[0][0] = (key[1][1])*inverso%n
inversematrix[0][1] = (key[0][1]*(-1))*inverso%n
inversematrix[1][0] = (key[1][0]*(-1))*inverso%n
inversematrix[1][1] = (key[0][0])*inverso%n
